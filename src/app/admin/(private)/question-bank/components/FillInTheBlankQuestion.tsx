    ...
    <div>
      <div className="mb-5 rounded-xl bg-[#3a1737] py-8">
        <div className="mx-auto w-full max-w-[500px]">
          <input
            type="text"
            style={{ boxShadow: 'none', borderColor: 'transparent', borderBottom: '3px solid white' }}
            className="w-full rounded-md bg-[#f9fbfd23] text-lg text-white outline-none"
        ...
        <div className="">
          <div className="mx-auto flex w-full max-w-[500px] gap-2">
            ...
            <div>
              <input
                type="text"
                style={{ boxShadow: 'none', border: 'transparent' }}
                className="w-[315px] rounded-md bg-[#f9fbfd23] py-[11px] text-[18px] text-white outline-none"
