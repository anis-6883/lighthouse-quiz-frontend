  ...
  return (
    <>
      <div className="flex w-full items-center justify-between p-4">
        <div
          onClick={() => {
            const settingLogout = document.getElementById(
              'setting_logout'
        ...
        >
          ...
          <span className="text-lg font-medium capitalize text-[#F75555] sm:text-xl">
            Logout
          </span>
        </div>
      </div>
      ...
      >
        <div className="modal-box rounded-t-[3rem] text-center">
          ...
          <h2 className="py-8 text-[22px] font-semibold">
