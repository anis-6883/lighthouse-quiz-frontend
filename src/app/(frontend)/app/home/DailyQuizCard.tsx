...
export default function DailyQuizCard({ name, image, date, status }: { name: string; image: string; date: Date; status: string }) {
  ...
  return (
    <div className="card card-compact mx-1 max-w-56 border bg-base-100 shadow-base-content">
      <figure className="relative">
        ...
        <span className="absolute bottom-4 right-2 z-10 rounded-md bg-[#0d6efd] p-1 text-[10px] text-white sm:text-[12px] ">12 Qs</span>
      </figure>
